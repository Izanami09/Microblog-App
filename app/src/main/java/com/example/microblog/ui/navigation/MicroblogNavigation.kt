...
import com.example.microblog.ui.presentation.screens.authscreen.RegisterScreen
...
fun MicroblogNavigation(){
    ...
    NavHost(navController = navController, startDestination = MicroblogScreen.Splash.route){
        ...
        composable(MicroblogScreen.Register.route){ RegisterScreen(navController = navController, viewModel = hiltViewModel())}
        composable(MicroblogScreen.Home.route){ HomeScreen(modifier = Modifier, viewModel = hiltViewModel(), navController = navController)}
    }
